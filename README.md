...
Moreover, there is a command-line interface to generate all prompts from a `.prm` file. To invoke the command-line interface, simply run the following command: 
