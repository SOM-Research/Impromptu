...
exports.TraitValidator = 'TraitValidator';
function isTraitValidator(item) {
    return exports.reflection.isInstance(item, exports.TraitValidator);
}
exports.isTraitValidator = isTraitValidator;
